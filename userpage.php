...
<div class="button-container">
    <a href="#" id="salarySlipButton" class="link-button">Salary Slip</a>
    <button id="leavesButton">Leaves</button>
...
<script>
    ...
    document.getElementById('salarySlipButton').addEventListener('click', function(event) {
        event.preventDefault(); 
        toggleIframe("employee.php"); 
    });

    document.getElementById('leavesButton').addEventListener('click', function() {
        toggleIframe("leaves.php"); 
    });
